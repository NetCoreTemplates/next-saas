...
export default function PricingPage() {
  ...
  const paidPlans = plans.filter(plan => !plan.isContactSales && plan.prices?.some(x => (x.unitAmount ?? 0) > 0))
  const featuredCode = (paidPlans.find(plan => (plan.trialDays ?? 0) > 0) ?? paidPlans[0])?.code
